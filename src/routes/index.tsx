    ...
    <>
      ...
      <Layout>
        ...
        <div id="thesis" className="relative z-10 bg-background">
          ...
          {/* THESIS — no boxShadow so it sits flush with what follows */}
          <section id="thesis-split" className="relative flex min-h-[620px] overflow-hidden">
            ...
            {/* ── RIGHT IMAGE — with thin red vertical rule ─────────────── */}
            <div className="hidden md:flex flex-1 relative items-center justify-center bg-background">

              {/* Image at 75% — white gap all round */}
              <div className="relative" style={{ width: "75%", aspectRatio: "4 / 3" }}>
                <img
                  src={hero1}
              ...
              {/* Thin red vertical rule — right edge of the column */}
              <div
                aria-hidden
                className="absolute top-[8%] bottom-[8%] right-0"
                style={{ width: "1px", background: "#c0392b", opacity: 0.8 }}
              />
          ...
          <section className="relative mt-40 md:mt-56 overflow-hidden">
            ...
            {/* Hairline circle arcs — bleed off left edge, barely visible */}
            <svg
              aria-hidden
            ...
            >
              {/* Large arc bleeding off left */}
              <circle cx="-8" cy="48" r="36" fill="none" stroke="rgba(26,22,18,0.1)" strokeWidth="0.15" />
              {/* Smaller concentric arc */}
              <circle cx="-8" cy="48" r="22" fill="none" stroke="rgba(26,22,18,0.07)" strokeWidth="0.12" />
            </svg>
