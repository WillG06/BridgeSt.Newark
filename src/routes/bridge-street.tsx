  ...
  return (
    <Layout>
      ...
      <section className="sticky top-0 dark-section h-[100svh] -mt-24 overflow-hidden">
        <img
          src={hero3}
          alt="Newark on Trent market square at dawn from above"
      ...
      <div className="relative z-10 bg-background">
        ...
        {/* Intro */}
        <section className="pt-32 md:pt-48 px-6 md:px-10 grid grid-cols-12 gap-6">
              ...
              <article key={c.n} className="px-6 md:px-10">
                <div className="grid grid-cols-12 gap-6 mb-12">
                  ...
                  <div className="col-span-10 md:col-span-8">
                    <SplitWords as="h2" stagger={90} className="font-display text-5xl md:text-8xl leading-[0.9] text-foreground">
                      {c.name}
                    </SplitWords>
                    <SplitWords as="p" delay={200} stagger={70} className="font-serif-i text-moss text-2xl md:text-4xl mt-2">
                      {c.italic}
                    </SplitWords>
                  </div>
